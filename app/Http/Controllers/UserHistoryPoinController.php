...
class UserHistoryPoinController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('page.users.penukaranPoin.index', compact('title'));
    }
    ...
    public function getPenukaranPoin(Request $request)
    {
        try {
            if ($request->ajax()) {
                $data = PenukaranPoin::where("user_id", Auth()->user()->id)->get();
